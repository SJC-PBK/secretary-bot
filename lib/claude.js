...
const SAFETY_BASE =
  ...
  '또한 사용자가 슬랙에 텍스트 파일(.txt 등)을 첨부하거나 그 파일의 링크(URL)를 주면, 시스템이 그 내용을 읽어 이 대화에 함께 넣어 준다(오디오·이미지는 제외). ' +
...
module.exports = { ask, parseReminder, interpret, extractFacts, buildDocSpec, buildDriveDoc, buildSlides, editDocMarkdown, mapFormFields, extractActionItems, buildEmail, extractContact, buildFormSpec, buildCanvas, weather };
